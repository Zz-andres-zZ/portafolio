        ...
        <div class="row m-0">
            <div class="col-2 col-lg-1 social">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="btn btn-dark p-1 px-2 rounded-2" href="https://discord.gg/midudev" target="_blank"><i class="bi bi-discord"></i></a>
                    </li>
                    <li class="nav-item my-4">
                        <a class="btn btn-dark p-1 px-2 rounded-2" href="https://www.linkedin.com/in/andreshmndz/" target="_blank"><i class="bi bi-linkedin"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-dark p-1 px-2 rounded-2" href="https://github.com/Zz-andres-zZ" target="_blank"><i class="bi bi-github" target="_blank"></i></a>
                    </li>
                </ul>
            </div>
            <div class="col-12 col-lg-5 inf-profile">
                <div class="presentacion w-100 align-items-center justify-content-center text-center text-start-md">
                    <h1 class="title display-1">Andrés Hndz</h1>
                    <h3 class="subtitle">Web developer
                        <svg class="ms-3 d-none d-lg-block" width="36" height="36" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="home__hand">
                    ...
                    <a href="contact" class="btn btn-dark p-2 px-4">
                        Contactame
                        <svg class="text-primary ms-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="block">
...
<section id="skill">
    <div class="container">
        <div class="row m-0 gap-4 gap-lg-0">
            <div class="skill mb-5 text-center">
                <h2 class="display-1">Skills</h2>
                <p class="m-0 fs-4">Mi nivel tecnico</p>
            </div>
            <div class="col-12 col-lg-6">
                <div class="row-cols-2 box_skill rounded-2 gap-3">
