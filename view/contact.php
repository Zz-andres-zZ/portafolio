<section id="contact">
    <div class="container">
        <div class="row m-0">
            ...
            <div class="col-12 col-lg-6">
                <h3 class="contact-title">Write me your project</h3>
                <form class="form-control" action="#" method="post">
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <i class="bi bi-person-circle"></i>
                            <input name="fname" type="text" placeholder="First Name" class="form-control " require>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <i class="bi bi-person-circle"></i>
                            <input name="lname" type="text" placeholder="Last Name" class="form-control" require>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <i class="bi bi-envelope-at"></i>
                            <input name="email" type="email" placeholder="Email Address" class="form-control" require>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <i class="bi bi-telephone"></i>
                            <input name="tel" type="tel" placeholder="+58 12345678" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <textarea class="form-control" id="message" name="message" placeholder="Enter your massage for us here. We will get back to you within 2 business days." rows="6" require></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <input type="submit" name="submit" value="Send Message" class="btn btn-dark w-50">
