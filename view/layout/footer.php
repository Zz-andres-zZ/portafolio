            ...
            <div class="row m-0">
                <div class="col-12">
                    ...
                    <ul id="social" class="nav">
                        <li class="nav-item">
                            <a class="btn btn-dark p-1 px-2 rounded-4" href="#"><i class="bi bi-discord text-white"></i></a>
                        </li>
                        <li class="nav-item mx-4">
                            <a class="btn btn-dark p-1 px-2 rounded-4" href="#"><i class="bi bi-linkedin text-white"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-dark p-1 px-2 rounded-4" href="#"><i class="bi bi-github text-white"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
